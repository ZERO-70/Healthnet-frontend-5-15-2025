...
function ManageMedicalRecords() {
    ...
    const handleDelete = async (recordId) => {
        ...
        if (window.confirm('Are you sure you want to delete this medical record? This action cannot be undone.')) {
            ...
            try {
                ...
                const response = await fetch(`${API_BASE_URL}/medical_record/${recordId}`, {
                    method: 'DELETE',
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json',
    ...
    const handleUpdateSubmit = async (formData) => {
        ...
        try {
            ...
            const response = await fetch(
                `${API_BASE_URL}/medical_record/${formData.recordId}`, {
                    method: 'PUT',
                    headers: {
                        'Authorization': `Bearer ${token}`,
                        'Content-Type': 'application/json',
    ...
    const handleEditRecord = async (record) => {
        try {
            ...
            const response = await fetch(`${API_BASE_URL}/medical_record/${record.recordId}`, {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json',
